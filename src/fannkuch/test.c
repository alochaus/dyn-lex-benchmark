     ...
     // MAIN
        int main (int ceu_argc, char** ceu_argv) {
            ...
            CEU_Value ceu_acc;        
                    ...
                    { // BLOCK | 
                        CEU_Block _ceu_block_1164 = (CEU_Block) { 1, 1, {.frame=&_ceu_frame_}, NULL };
                        CEU_Block* ceu_block_1164 = &_ceu_block_1164; 
                        
                            // main block varargs (...)
                            CEU_Value id__dot__dot__dot_ = ceu_tuple_create(ceu_block_1164, ceu_argc);
                            for (int i=0; i<ceu_argc; i++) {
                                CEU_Value vec = ceu_vector_from_c_string(ceu_block_1164, ceu_argv[i]);
                ...
                // UPVALS
                        ...
                        ceu_assert_pre(
                            ceu_block_1164,
                            ceu_hold_chk_set(&ceu_block_1164->dyns, ceu_block_1164->depth, CEU_HOLD_MUTAB, ceu_acc, 0, "declaration error"),
                ...
                // UPVALS
                    ...
                    CEU_Value ceu_set_952 = ceu_acc;
                        ...
                        { // ACC - SET
                            ceu_assert_pre(
                                ceu_block_1164,
                                ceu_hold_chk_set(&ceu_block_1164->dyns, ceu_block_1164->depth, CEU_HOLD_MUTAB, (ceu_set_952), 0, "set error"),
...
ceu_args_1096[0] = ceu_acc;
                ...
                { // VECTOR | 
                    CEU_Value ceu_vec_1114 = ceu_vector_create(ceu_block_1164);
                    
                    ceu_acc = ceu_vec_1114;
                }
                ...
                { // SET | 
                    ...
                    CEU_Value ceu_set_1128 = ceu_acc;
                    
                { // INDEX | 
                    // IDX
                    
                        ceu_acc = ((CEU_Value) { CEU_VALUE_NUMBER, {.Number=0} });
                        CEU_Value ceu_idx_1124 = ceu_acc;
                        
                    // COL
                    ceu_acc = id_a;

                    ceu_assert_pre(ceu_block_1164, ceu_col_check(ceu_acc, ceu_idx_1124), "test.ceu : (lin 2, col 5)");
                
                        CEU_Value ok = { CEU_VALUE_NIL };
                        switch (ceu_acc.type) {
                            case CEU_VALUE_TUPLE:
                                ok = ceu_tuple_set(&ceu_acc.Dyn->Tuple, ceu_idx_1124.Number, (ceu_set_1128));
                                break;
                            case CEU_VALUE_VECTOR:
                                ok = ceu_vector_set(&ceu_acc.Dyn->Vector, ceu_idx_1124.Number, (ceu_set_1128));
                                break;
                            case CEU_VALUE_DICT: {
                                CEU_Value ceu_dict = ceu_acc;
                                ok = ceu_dict_set(&ceu_dict.Dyn->Dict, ceu_idx_1124, (ceu_set_1128));
                                break;
                            }
                            default:
                                assert(0 && "bug found");
                        }
                        ceu_assert_pre(ceu_block_1164, ok, "test.ceu : (lin 2, col 5)");
                        
                }
                
                    ceu_acc = ceu_set_1128;
                }
                ...
                { // CALL | 
                    ...
                    if (ceu_closure_1139.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1164, "test.ceu : (lin 3, col 1)", err);
                    }
                    CEU_Frame ceu_frame_1139 = { &ceu_closure_1139.Dyn->Closure, ceu_block_1164 };
                    
                    CEU_Value ceu_args_1139[1];
                    
                    
                { // CALL | 
                    ceu_acc = op_hash;

                    CEU_Value ceu_closure_1137 = ceu_acc;
                    if (ceu_closure_1137.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1164, "test.ceu : (lin 3, col 9)", err);
                    }
                    CEU_Frame ceu_frame_1137 = { &ceu_closure_1137.Dyn->Closure, ceu_block_1164 };
                    
                    CEU_Value ceu_args_1137[1];
                    
                    ceu_acc = id_a;
ceu_args_1137[0] = ceu_acc;

                    
                    

                    ceu_acc = ceu_frame_1137.closure->proto (
                        &ceu_frame_1137,
                        1,
                        ceu_args_1137
                    );
                    ceu_assert_pre(ceu_block_1164, ceu_acc, "test.ceu : (lin 3, col 9) : call error");
                } // CALL
                ceu_args_1139[0] = ceu_acc;
                    ...
                    ceu_assert_pre(ceu_block_1164, ceu_acc, "test.ceu : (lin 3, col 1) : call error");
                } // CALL
                
                { // SET | 
                    ceu_acc = ((CEU_Value) { CEU_VALUE_NUMBER, {.Number=2} });
                    CEU_Value ceu_set_1155 = ceu_acc;
                ...
                { // CALL | 
                    ...
                    CEU_Value ceu_closure_1149 = ceu_acc;
                    if (ceu_closure_1149.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1164, "test.ceu : (lin 4, col 7)", err);
                    }
                    CEU_Frame ceu_frame_1149 = { &ceu_closure_1149.Dyn->Closure, ceu_block_1164 };
                    
                    CEU_Value ceu_args_1149[1];
                    
                    ceu_acc = id_a;
ceu_args_1149[0] = ceu_acc;

                    
                    

                    ceu_acc = ceu_frame_1149.closure->proto (
                        &ceu_frame_1149,
                        1,
                        ceu_args_1149
                    );
                    ceu_assert_pre(ceu_block_1164, ceu_acc, "test.ceu : (lin 4, col 7) : call error");
                } // CALL
                
                        CEU_Value ceu_idx_1151 = ceu_acc;
                        
                    // COL
                    ceu_acc = id_a;

                    ceu_assert_pre(ceu_block_1164, ceu_col_check(ceu_acc, ceu_idx_1151), "test.ceu : (lin 4, col 5)");
                
                        CEU_Value ok = { CEU_VALUE_NIL };
                        switch (ceu_acc.type) {
                            case CEU_VALUE_TUPLE:
                                ok = ceu_tuple_set(&ceu_acc.Dyn->Tuple, ceu_idx_1151.Number, (ceu_set_1155));
                                break;
                            case CEU_VALUE_VECTOR:
                                ok = ceu_vector_set(&ceu_acc.Dyn->Vector, ceu_idx_1151.Number, (ceu_set_1155));
                                break;
                            case CEU_VALUE_DICT: {
                                CEU_Value ceu_dict = ceu_acc;
                                ok = ceu_dict_set(&ceu_dict.Dyn->Dict, ceu_idx_1151, (ceu_set_1155));
                                break;
                            }
                            default:
                                assert(0 && "bug found");
                        }
                        ceu_assert_pre(ceu_block_1164, ok, "test.ceu : (lin 4, col 5)");
                        
                }
                
                    ceu_acc = ceu_set_1155;
                }
                
                { // CALL | 
                    ceu_acc = id_println;

                    CEU_Value ceu_closure_1162 = ceu_acc;
                    if (ceu_closure_1162.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1164, "test.ceu : (lin 6, col 1)", err);
                    }
                    CEU_Frame ceu_frame_1162 = { &ceu_closure_1162.Dyn->Closure, ceu_block_1164 };
                    
                    CEU_Value ceu_args_1162[1];
                    
                    ceu_acc = id_a;
ceu_args_1162[0] = ceu_acc;

                    
                    

                    ceu_acc = ceu_frame_1162.closure->proto (
                        &ceu_frame_1162,
                        1,
                        ceu_args_1162
                    );
                    ceu_assert_pre(ceu_block_1164, ceu_acc, "test.ceu : (lin 6, col 1) : call error");
                } // CALL
                        ...
                        // <<< block
                            ...
                            if (op_ampersand_ampersand.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_ampersand_ampersand, (op_ampersand_ampersand.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_bar_bar.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_bar_bar, (op_bar_bar.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_plus.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_plus, (op_plus.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_minus.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_minus, (op_minus.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_asterisk.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_asterisk, (op_asterisk.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_asterisk_asterisk.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_asterisk_asterisk, (op_asterisk_asterisk.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_slash.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_slash, (op_slash.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_slash_slash.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_slash_slash, (op_slash_slash.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_null.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_null, (op_null.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_greater_equals.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_greater_equals, (op_greater_equals.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_greater.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_greater, (op_greater.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_less_equals.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_less_equals, (op_less_equals.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (op_less.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_less, (op_less.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (id_to_dash_string.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_string, (id_to_dash_string.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (id_to_dash_number.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_number, (id_to_dash_number.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (id_to_dash_tag.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_tag, (id_to_dash_tag.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                            if (id_a.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_a, (id_a.Dyn->Any.hld_depth == ceu_block_1164->depth));
                            }
                        
                        
                        ceu_block_free(ceu_block_1164);
                    }
