     ...
     // MAIN
        int main (int ceu_argc, char** ceu_argv) {
            ...
            CEU_Value ceu_acc;        
                    ...
                    { // BLOCK | 
                        CEU_Block _ceu_block_1143 = (CEU_Block) { 1, 1, {.frame=&_ceu_frame_}, NULL };
                        CEU_Block* ceu_block_1143 = &_ceu_block_1143; 
                        
                            // main block varargs (...)
                            CEU_Value id__dot__dot__dot_ = ceu_tuple_create(ceu_block_1143, ceu_argc);
                            for (int i=0; i<ceu_argc; i++) {
                                CEU_Value vec = ceu_vector_from_c_string(ceu_block_1143, ceu_argv[i]);
                ...
                // UPVALS
                        ...
                        ceu_assert_pre(
                            ceu_block_1143,
                            ceu_hold_chk_set(&ceu_block_1143->dyns, ceu_block_1143->depth, CEU_HOLD_MUTAB, ceu_acc, 0, "declaration error"),
                ...
                // UPVALS
                    ...
                    CEU_Value ceu_set_952 = ceu_acc;
                        ...
                        { // ACC - SET
                            ceu_assert_pre(
                                ceu_block_1143,
                                ceu_hold_chk_set(&ceu_block_1143->dyns, ceu_block_1143->depth, CEU_HOLD_MUTAB, (ceu_set_952), 0, "set error"),
...
ceu_args_1096[0] = ceu_acc;
                ...
                // DCL | 
                ceu_acc = ((CEU_Value) { CEU_VALUE_NUMBER, {.Number=0.000000000000001} });
                        ceu_assert_pre(
                            ceu_block_1143,
                            ceu_hold_chk_set(&ceu_block_1143->dyns, ceu_block_1143->depth, CEU_HOLD_MUTAB, ceu_acc, 0, "declaration error"),
                ...
                { // CALL | 
                    ...
                    CEU_Value ceu_closure_1126 = ceu_acc;
                    if (ceu_closure_1126.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1143, "test.ceu : (lin 2, col 13)", err);
                    }
                    CEU_Frame ceu_frame_1126 = { &ceu_closure_1126.Dyn->Closure, ceu_block_1143 };
                    
                    CEU_Value ceu_args_1126[2];
                    
                    ceu_acc = ((CEU_Value) { CEU_VALUE_NUMBER, {.Number=1.0E} });ceu_args_1126[0] = ceu_acc;
ceu_acc = ((CEU_Value) { CEU_VALUE_NUMBER, {.Number=05} });ceu_args_1126[1] = ceu_acc;

                    
                    

                    ceu_acc = ceu_frame_1126.closure->proto (
                        &ceu_frame_1126,
                        2,
                        ceu_args_1126
                    );
                    ceu_assert_pre(ceu_block_1143, ceu_acc, "test.ceu : (lin 2, col 13) : call error");
                } // CALL
                ...
                { // CALL | 
                    ...
                    if (ceu_closure_1134.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1143, "test.ceu : (lin 3, col 1)", err);
                    }
                    CEU_Frame ceu_frame_1134 = { &ceu_closure_1134.Dyn->Closure, ceu_block_1143 };
                    
                    CEU_Value ceu_args_1134[1];
...
ceu_args_1134[0] = ceu_acc;
                    ...
                    ceu_assert_pre(ceu_block_1143, ceu_acc, "test.ceu : (lin 3, col 1) : call error");
                } // CALL
                
                { // CALL | 
                    ceu_acc = id_println;

                    CEU_Value ceu_closure_1141 = ceu_acc;
                    if (ceu_closure_1141.type != CEU_VALUE_CLOSURE) {
                        CEU_Value err = { CEU_VALUE_ERROR, {.Error="call error : expected function"} };
                        ceu_ferror_pre(ceu_block_1143, "test.ceu : (lin 4, col 1)", err);
                    }
                    CEU_Frame ceu_frame_1141 = { &ceu_closure_1141.Dyn->Closure, ceu_block_1143 };
                    
                    CEU_Value ceu_args_1141[1];
                    
                    ceu_acc = id_y;
ceu_args_1141[0] = ceu_acc;

                    
                    

                    ceu_acc = ceu_frame_1141.closure->proto (
                        &ceu_frame_1141,
                        1,
                        ceu_args_1141
                    );
                    ceu_assert_pre(ceu_block_1143, ceu_acc, "test.ceu : (lin 4, col 1) : call error");
                } // CALL
                        ...
                        // <<< block
                            ...
                            if (op_ampersand_ampersand.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_ampersand_ampersand, (op_ampersand_ampersand.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_bar_bar.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_bar_bar, (op_bar_bar.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_plus.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_plus, (op_plus.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_minus.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_minus, (op_minus.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_asterisk.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_asterisk, (op_asterisk.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_asterisk_asterisk.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_asterisk_asterisk, (op_asterisk_asterisk.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_slash.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_slash, (op_slash.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_slash_slash.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_slash_slash, (op_slash_slash.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_null.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_null, (op_null.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_greater_equals.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_greater_equals, (op_greater_equals.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_greater.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_greater, (op_greater.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_less_equals.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_less_equals, (op_less_equals.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (op_less.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(op_less, (op_less.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (id_to_dash_string.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_string, (id_to_dash_string.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (id_to_dash_number.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_number, (id_to_dash_number.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (id_to_dash_tag.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_to_dash_tag, (id_to_dash_tag.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (id_x.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_x, (id_x.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                            if (id_y.type > CEU_VALUE_DYNAMIC) {
                                ceu_gc_dec(id_y, (id_y.Dyn->Any.hld_depth == ceu_block_1143->depth));
                            }
                        
                        
                        ceu_block_free(ceu_block_1143);
                    }
